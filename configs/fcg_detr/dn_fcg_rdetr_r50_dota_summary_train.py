...
data = dict(
    ...
    train=dict(
        type='DOTADataset',
        ann_file=
        '/workspace/DATASET/DOTA_split/split_ss_dota1_0/trainval/annfiles/',
        img_prefix=
        '/workspace/DATASET/DOTA_split/split_ss_dota1_0/trainval/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RResize', img_scale=(1024, 1024)),
    ...
    val=dict(
        type='DOTADataset',
        ann_file='/workspace/DATASET/DOTA_split/split_ss_dota1_0/val/annfiles/',
        img_prefix='/workspace/DATASET/DOTA_split/split_ss_dota1_0/val/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='DOTADataset',
        ann_file='/workspace/DATASET/DOTA_split/split_ss_dota1_0/test/images/',
        img_prefix=
        '/workspace/DATASET/DOTA_split/split_ss_dota1_0/test/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
