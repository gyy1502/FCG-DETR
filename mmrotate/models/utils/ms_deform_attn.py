...
def multi_scale_deformable_attn_pytorch(
    ...
    # value_list = value.split(value_spatial_shapes.prod(-1).unbind(0), dim=1)  ##原本
    value_spatial_shapes_prod = value_spatial_shapes[:, 0] * value_spatial_shapes[:, 1]
    value_list = value.split(value_spatial_shapes_prod.unbind(0), dim=1)
